const mammalsData = [
	...
	{
		title: "Le buffle",
		image: "../assets/img/monptitbuffle.jpg",
...
// Je crée chaque carte dynamiquement
mammalsData.forEach((item) => {
    ...
    cardImage.classList.add("card-img-top", "cardImage");
    cardImage.alt = item.title;

	// Création du contenu de la card
    ...
    cardText.classList.add("card-text", "cardContent");
